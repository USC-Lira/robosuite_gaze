...
from robosuite.gamepad.gamepad import Gamepad
...
class Xbox360(Gamepad):
    ...
    def __init__(self, joystickNumber=0):
        Gamepad.__init__(self, joystickNumber)
        self.axisNames = {0: "LEFT-X", 1: "LEFT-Y", 2: "LT", 3: "RIGHT-X", 4: "RIGHT-Y", 5: "RT"}
        self.buttonNames = {
            0: "A",
            1: "B",
            2: "X",
...
class GameHat(Gamepad):
    ...
    def __init__(self, joystickNumber=0):
        ...
        self.buttonNames = {0: "A", 1: "B", 2: "X", 3: "Y", 4: "TR", 5: "TL", 6: "SELECT", 7: "START"}
        self._setupReverseMaps()
